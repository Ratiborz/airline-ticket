    ...
    <div className={s.transfers}>
      ...
      <div className={s.wrapper__transfers}>
        <label className={s.transfers__li}>
          <input type="checkbox" onChange={(e) => dispatch(actions.sortByStops(0))} />
          <span className={s.custom_checkbox}></span>
          Без пересадок
        </label>
        <label className={s.transfers__li}>
          <input type="checkbox" onChange={(e) => dispatch(actions.sortByStops(1))} />
          <span className={s.custom_checkbox}></span>1 пересадка
        </label>
        <label className={s.transfers__li}>
          <input type="checkbox" onChange={(e) => dispatch(actions.sortByStops(2))} />
          <span className={s.custom_checkbox}></span>2 пересадки
        </label>
        <label className={s.transfers__li}>
          <input type="checkbox" onChange={(e) => dispatch(actions.sortByStops(3))} />
